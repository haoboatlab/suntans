...
/* sparse variables output
*/
const int outputNetcdfSparse_DEFAULT = 0;

/* compute average reynolds stresses
*/
const int calcreynolds_DEFAULT = 0;

/* AVG output comp steps to skip
*/
const int skipAvgOutput_DEFAULT = 0;

/* output comp steps to skip
*/
const int skipOutput_DEFAULT = 0;
