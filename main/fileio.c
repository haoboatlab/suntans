...
double GetDefaultValue(char *str, int *status) {
 ...
 } else if(!strcmp(str,"outputNetcdfSparse")){
    
    return outputNetcdfSparse_DEFAULT;

 } else if(!strcmp(str,"calcreynolds")){
    
    return calcreynolds_DEFAULT;

 } else if(!strcmp(str,"skipAvgOutput")){
    
    return skipAvgOutput_DEFAULT;

 } else if(!strcmp(str,"skipOutput")){
    
    return skipOutput_DEFAULT;
